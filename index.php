...
<body>
        ...
        <nav class="max-w-7xl mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="barinaklar.php" class="text-stone-600 hover:text-primary font-semibold transition duration-300">Barınaklar</a>
    ...
    <main class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600 mb-8">Sevgi dolu dostlarımıza yuva bulma platformu</p>
        ...
        <div class="mb-16">
            <div class="bg-gradient-to-r from-primary to-primary-light rounded-2xl p-8 text-white">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold mb-2">İlanı İnceleyin</h3>
                        <p class="text-sm opacity-90">Beğendiğiniz hayvanın detaylarını okuyun, fotoğraflarını inceleyin</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold mb-2">İletişime Geçin</h3>
                        <p class="text-sm opacity-90">İlan sahibi ile iletişime geçin, sorularınızı sorun</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold mb-2">Hayvanla Tanışın</h3>
                        <p class="text-sm opacity-90">Hayvanı görmeye gidin, uyumunuzu test edin</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-lg font-semibold mb-2">Yuvanıza Alın</h3>
                        <p class="text-sm opacity-90">Gerekli hazırlıkları yapın ve yeni dostunuzu yuvanıza alın</p>
                    </div>
                </div>
            </div>
        </div>
