...
<div class="container mx-auto px-4 py-8 mt-16 md:mt-24"> <h1 class="text-4xl font-extrabold text-center text-koyu-pembe mb-8">Sahiplendirme İlanları</h1>
            ...
            <?php while ($ilan = $result->fetch_assoc()): ?>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex items-center p-3 gap-3 relative">
                    <div class="w-24 h-24 flex-shrink-0">
                        <img src="images/<?= htmlspecialchars($ilan['foto'] ?: 'placeholder.jpg') ?>" alt="<?= htmlspecialchars($ilan['baslik']) ?>"
