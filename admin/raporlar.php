...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <a href="kullanici_yonetim.php" class="bg-white border-l-4 border-orange-500 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-600 text-sm font-medium uppercase tracking-wider">Toplam Kullanıcı</p>
                    <p class="text-3xl font-bold text-gray-800"><?= number_format($stats['toplam_kullanici']) ?></p>
                </div>
